...
const Table = () => {
    ...
    return (
    <div classNameName="container mx-auto mt-10">
        ...
        <thead>
          <tr>
            <th className="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
              ...
              <span className="xl:hidden lg:hidden md:hidden sm:hidden block">Пнд</span>
            </th>
            <th className="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
              <span className="xl:block lg:block md:block sm:block hidden">Вторник</span>
              <span className="xl:hidden lg:hidden md:hidden sm:hidden block">Втр</span>
            </th>
            <th className="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
            ...
            <th className="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
              ...
              <span className="xl:hidden lg:hidden md:hidden sm:hidden block">Чет</span>
            </th>
            <th className="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
              <span className="xl:block lg:block md:block sm:block hidden">Пятница</span>
              <span className="xl:hidden lg:hidden md:hidden sm:hidden block">Пят</span>
            </th>
            <th className="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
              <span className="xl:block lg:block md:block sm:block hidden">Суббота</span>
              <span className="xl:hidden lg:hidden md:hidden sm:hidden block">Суб</span>
            </th>
            <th className="p-2 border-r h-10 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 xl:text-sm text-xs">
              <span className="xl:block lg:block md:block sm:block hidden">Воскресенье</span>
              <span className="xl:hidden lg:hidden md:hidden sm:hidden block">Вос</span>
            </th>
          </tr>
        </thead>
        <tbody>
